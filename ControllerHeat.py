...
class ControllerHeat:
    def __init__(self):
        ...
        self.heat1_type_value = ["Y1", "HE1"]
        self.heat2_type_value = "Y2"
    ...
    def setHeat2(self):
        for i in range(0, len(self.name_var_scheme)):
            if (self.name_var_scheme[i] == self.heat2_type_value):
                self.heat2_use = 1
                self.heat2_type = 1
                return 0

    def getDataForModbus(self):
        self.data_for_modbus = ((self.heat2_type, self.reg_heat[0]), (self.heat2_use, self.reg_heat[1]), (self.heat2_type, self.reg_heat[2]))
