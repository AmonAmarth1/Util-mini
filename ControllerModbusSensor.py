...
class ControllerModbusSensor:
    ...
    def makeDataModbus(self, nameVarSpecification, productNumner):
        self.setNameVarSchemeAndProductNumber(nameVarSpecification, productNumner)
        self.setModbusSensors()
